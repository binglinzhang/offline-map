window.BMAP_AUTHENTIC_KEY = "077E114C2eb9cf894df88566ea8cfce7"; (function() {
	...
	function debugLog(str)
	{
		//showDebug();
	    var now=new Date();
	    if(document.getElementById('debugOut'))
	    {
	    	document.getElementById('debugOut').innerHTML=''+now.getHours()+':'+now.getMinutes()+':'+now.getSeconds()+' '
	        +str
	        +'<br/>'+document.getElementById('debugOut').innerHTML;
	    }    
	};
    function La(a, b) {
    	var changed=false;
		//console.log(a);
    	//debugLog(a);
    	if(a.length!=a.replace('mapclick.map.baidu.com/data/','').length)//http://mapclick.map.baidu.com/data/91_22_11_018.js
    	{
    		//console.log(a);
    		return;
    	}
    	if(a.length!=a.replace('map.bdimg.com:8080/gvd/1?qt=style','').length)//http://or.map.bdimg.com:8080/gvd/?qt=style
    	{
    		//console.log(a);
    		return;
    	}
    	if(a.length!=a.replace('map.bdimg.com:8080/gvd/2?qt=style','').length)//http://or.map.bdimg.com:8080/gvd/?qt=style
    	{
    		//console.log(a);
    		return;
    	}
    	if(a.length!=a.replace('map.bdimg.com:8080/gvd/3?qt=style','').length)//http://or.map.bdimg.com:8080/gvd/?qt=style
    	{
    		//console.log(a);
    		return;
    	}
    	if(a.length!=a.replace('map.bdimg.com:8080/gvd/4?qt=style','').length)//http://or.map.bdimg.com:8080/gvd/?qt=style
    	{
    		//console.log(a);
    		return;
    	}
    	if(a.length!=a.replace('map.bdimg.com:8080/gvd/5?qt=style','').length)//http://or.map.bdimg.com:8080/gvd/?qt=style
    	{
    		//console.log(a);
    		return;
    	}
    	if(a.length!=a.replace('map.bdimg.com:8080/gvd/6?qt=style','').length)//http://or.map.bdimg.com:8080/gvd/?qt=style
    	{
    		//console.log(a);
    		return;
    	}
    	if(a.length!=a.replace('map.bdimg.com:8080/gvd/7?qt=style','').length)//http://or.map.bdimg.com:8080/gvd/?qt=style
    	{
    		//console.log(a);
    		return;
    	}
		if(a.length!=a.replace('map.bdimg.com:8080/gvd/?qt=style','').length)//http://or.map.bdimg.com:8080/gvd/?qt=style
    	{
			//console.log(a);
    		return;
    	}
    	if(a.length!=a.replace('api.map.baidu.com/?qt=verify','').length)//http://mapclick.map.baidu.com/data/91_22_11_018.js
    	{
    		a='js/api.map.baidu.com.verify.js?';
			//a=a.repalce("api.map.baidu.com/?qt=verify","baiduApiVerify.do?").replace("http://","");
    	}
    	//api.map.baidu.com/?qt=verify
		if(a.length!=a.replace('.map.bdimg.com:8080/gvd/?qt=lgvd','').length)
		{ 
			//alert(a);
			changed=true;
			//debugLog(a);
			a=urlPath+GetQueryString('z',a)+"/"+GetQueryString('x',a)+"/"+GetQueryString('y',a)+".jpg"+"?"+a;
			//alert(a);
		}
        ...
        if(!changed)
        {
            ...
            setTimeout(function() {
					//http://or.map.bdimg.com:8080/gvd/7?qt=lgvd&x=818&y=262&z=12&styles=pl&layers=bg,df&f=mwebapp&v=001&udt=20130501&fn=BMap._31cptic 
					if(d.src.length!=d.src.replace('or.map.bdimg.com:8080','').length)
					{
						var url = urlPath+'overlay/' + GetQueryString('z',d.src) + "/" + GetQueryString('x',d.src) + "/" + GetQueryString('y',d.src) + ".jpg"; //直接使用本地瓦片
						d.src=url;
					...
					//<script src="js/menu_load.js" type="text/javascript" charset="utf-8"></script>
					if(d.src.length==d.src.replace('menu_load.js','').replace('markeranimation_load.js','').length)
					{
    ...
    t.object.extend(G, {
                    ...
                    e.ls == o && (e.ls = i, setTimeout(function() {
						...
						if(0 == a.length){
							...
							for(var ai=0;ai<a.length;ai++){
								...
								//console.log(localurl+key+"_load.js");
        ...
        El: function(a) {
//if(a=='poly'){console.log(this.rc.Gh[a]);}
...
//if(a=='poly'){console.log(this.rc.Gh[a]);}
    ...
    function ac(a) {
        ...
        this.Uj = i;
        T.call(this, this.m);
        this.FJ = "http://or.map.bdimg.com:8080/gvd/1?qt=lgvd&styles=pl&layers=tf";
        this.ed = {
